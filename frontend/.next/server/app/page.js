...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7751)), "/home/san-cunha/Desktop/Desktop/UFOP/MonoII/RecSysExpFull/frontend/src/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 16660)), "/home/san-cunha/Desktop/Desktop/UFOP/MonoII/RecSysExpFull/frontend/src/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 82819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/home/san-cunha/Desktop/Desktop/UFOP/MonoII/RecSysExpFull/frontend/src/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 92123))
...
;// CONCATENATED MODULE: ./src/app/components/experiment/dataset/upload_dataset.tsx




const CsvUploader = ({ onSelectChange })=>{
    const [arquivoSelecionado, setArquivoSelecionado] = (0,react_.useState)(null);
    ...
    const handleUploadArquivo = ()=>{
        ...
        axios/* default */.Z.request(config).then((response)=>{
...
// );
// };
/* harmony default export */ const upload_dataset = (CsvUploader);

;// CONCATENATED MODULE: ./src/app/components/experiment/dataset/select.tsx
...
const Select = ({ onSelectChange })=>{
    ...
    (0,react_.useEffect)(()=>{
        ...
        axios/* default */.Z.request(configAxios).then((response)=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("select", {
                ...
                children: opcoesSelect.map((opcao)=>/*#__PURE__*/ jsx_runtime_.jsx("option", {
                        value: opcao,
                        children: opcao
                    }, opcao))
            })
...
/* harmony default export */ const dataset_select = (Select);

;// CONCATENATED MODULE: ./src/app/components/experiment/dataset/dataset.tsx




function Dataset(props) {
    const [selectedComponent, setSelectedComponent] = (0,react_.useState)("select");
...
;// CONCATENATED MODULE: ./src/app/components/experiment/custom_component.tsx
        ...
        switch(value_type){
            ...
            case "boolean":
                return /*#__PURE__*/ jsx_runtime_.jsx(node.FormControlLabel, {
                    control: /*#__PURE__*/ jsx_runtime_.jsx(node.Switch, {
                        checked: value,
            ...
            default:
                return /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    children: Object.entries(value).map(([nestedKey, nestedValue])=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                            children: mount_form(`${key}.${nestedKey}`, nestedValue)
                        }, nestedKey))
                });
        }
    };
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(node.FormControlLabel, {
                        control: props.checkbox ? /*#__PURE__*/ jsx_runtime_.jsx(node.Checkbox, {
                            onChange: (e)=>handle_checkbox(props.title, e.target.checked)
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(MyForm, {
                children: Object.entries(props.parameters).map(([key, value])=>/*#__PURE__*/ jsx_runtime_.jsx(node.Grid, {
                        item: true,
                        xs: 12,
                        sm: 6,
...
/* harmony default export */ const custom_component = (CustomComponent);

;// CONCATENATED MODULE: ./src/app/components/experiment/preprocessing/preprocessing.tsx
...
function PreProcessing(props) {
    const handle_change = (key, target)=>{
        ...
        const idx = props.preprocessing.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
            ...props.preprocessing["parameters"]["instances"][idx]["parameters"],
            [key.split("-")[1]]: target
        };
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.FormGroup, {
            ...
            children: props.preprocessing.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
...
/* harmony default export */ const preprocessing = (PreProcessing);

;// CONCATENATED MODULE: ./src/app/components/experiment/hybrid/hybrid.tsx
...
function Hybrid(props) {
    const handle_change = (key, target)=>{
        ...
        const idx = props.hybrid.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.FormGroup, {
            ...
            children: props.hybrid.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
                    father: "hybrid",
                    title: instance["class_name"],
                    parameters: instance["parameters"],
...
/* harmony default export */ const hybrid = (Hybrid);

;// CONCATENATED MODULE: ./src/app/components/experiment/metrics/metrics.tsx
...
function Metrics(props) {
    const handle_change = (key, target)=>{
        ...
        const idx = props.metrics.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.FormGroup, {
            ...
            children: props.metrics.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
                    father: "metrics",
                    title: instance["class_name"],
                    parameters: instance["parameters"],
...
/* harmony default export */ const metrics = (Metrics);

;// CONCATENATED MODULE: ./src/app/components/experiment/visualization/visualization.tsx
...
function Visualization(props) {
    const handle_change = (key, target)=>{
        ...
        console.log(new_instances);
        const idx = props.visualization.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"]["plot_types"] = {
            ...props.visualization["parameters"]["instances"][idx]["parameters"]["plot_types"],
            [key.split("-")[1]]: target
        };
        console.log(new_instances);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.FormGroup, {
            ...
            children: props.visualization.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
                    father: "visualization",
                    title: instance["class_name"],
                    parameters: instance["parameters"]["plot_types"],
                    set_parameters: handle_change,
                    checkbox: true,
                    set_list: props.set_list
                }, instance["class_name"]))
...
/* harmony default export */ const visualization = (Visualization);

;// CONCATENATED MODULE: ./src/app/components/experiment/metafeatures/metafeatures.tsx
...
function Metafeatures(props) {
    const handle_change_instances = (key, target)=>{
        ...
        const idx = props.metafeatures.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.FormGroup, {
            ...
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
                    father: "metafeatures",
                    title: "global",
                ...
                props.metafeatures.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                        idx: props.idx,
                        father: "metafeatures",
                        title: instance["class_name"],
                        parameters: instance["parameters"],
...
/* harmony default export */ const metafeatures = (Metafeatures);

;// CONCATENATED MODULE: ./src/app/components/experiment/recommenders/recommenders.tsx
...
function Recommenders(props) {
    const handle_change_instances = (key, target)=>{
        ...
        const idx = props.recommenders.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.FormGroup, {
            ...
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    ...
                    parameters: {
                        number_of_recommendations: props.recommenders.parameters.number_of_recommendations
                    },
                    set_parameters: handle_change_global,
                    checkbox: false,
                    set_list: props.set_list
                }, "number_of_recommendations"),
                props.recommenders.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                        idx: props.idx,
                        father: "recommenders",
                        title: instance["class_name"],
                        parameters: instance["parameters"],
...
/* harmony default export */ const recommenders = (Recommenders);

;// CONCATENATED MODULE: ./src/app/components/experiment/results/results.tsx
...
function Results(props) {
    const handle_change = (key, target)=>{
        ...
        const idx = props.results.parameters.instances.findIndex((e)=>e.class_name == key.split("-")[0]);
        new_instances[idx]["parameters"] = {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(node.FormGroup, {
            ...
            children: props.results.parameters.instances.map((instance)=>/*#__PURE__*/ jsx_runtime_.jsx(custom_component, {
                    idx: props.idx,
                    father: "results",
                    title: instance["class_name"],
                    parameters: instance["parameters"],
...
var ArrowDropDown = __webpack_require__(1241);
;// CONCATENATED MODULE: ./src/app/components/experiment/collapsible.tsx
...
const Collapsible = ({ title, component, header = false, experiment = false, set_experiment = ()=>{}, set_dependencies = ()=>{} })=>{
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx((IconButton_default()), {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(ArrowDropDown/* default */.Z, {})
                    })
                ]
            }),
...
/* harmony default export */ const collapsible = (Collapsible);

;// CONCATENATED MODULE: ./src/app/components/experiment/experiment.tsx
...
/* harmony default export */ const experiment_experiment = (Experiment);

;// CONCATENATED MODULE: ./src/app/components/form/form.tsx
...
function Form() {
    ...
    const format_experiment = (experiment, checkboxes)=>{
        const intersection = Object.keys(checkboxes).reduce((acc, category)=>{
            ...
            const selectedInstances = categoryInstances.filter((instance)=>selectedCheckboxes.includes(instance["class_name"]));
            return {
                ...acc,
        ...
        if (final_experiments) {
            final_experiments.map((aux, idx)=>{
                Object.entries(experiments[0]["checkeds"]).map(([key, value])=>{
                    if (key != "dataset") {
                        value.map((parameter)=>{
                            if (aux && !aux[key]["parameters"]["instances"].find((e)=>e.class_name == parameter)) {
                                aux[key]["parameters"]["instances"].push(experiments[0]["config"][key]["parameters"]["instances"].filter((e)=>e.class_name == parameter));
                            }
                        });
                    }
                });
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            experiments.map((experiment, idx)=>idx != experiments.length - 1 ? /*#__PURE__*/ jsx_runtime_.jsx(collapsible, {
                    header: true,
                    title: experiment["config"]["experiment_id"],
                    component: /*#__PURE__*/ jsx_runtime_.jsx(experiment_experiment, {
                        idx: idx,
                        experiment: experiment["config"],
                        set_experiment: set_experiments
                    })
                }, idx) : /*#__PURE__*/ jsx_runtime_.jsx(collapsible, {
                    header: true,
                    experiment: true,
                    set_experiment: set_experiments,
...
;// CONCATENATED MODULE: ./src/app/components/home/home.tsx
...
/* harmony default export */ const home_home = (HomePage);
...
/* harmony import */ var next_font_google_target_css_path_src_app_layout_tsx_import_Inter_arguments_subsets_latin_variableName_inter___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46708);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/san-cunha/Desktop/Desktop/UFOP/MonoII/RecSysExpFull/frontend/src/app/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [697,550], () => (__webpack_exec__(44295)));
