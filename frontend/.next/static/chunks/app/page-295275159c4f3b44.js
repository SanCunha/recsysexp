        ...
        Z = function (e) {
          let s = (s, t) => {
            let r = e.visualization.parameters.instances,
              a = e.visualization.parameters.instances.findIndex(
                (e) => e.class_name == s.split("-")[0]
              );
            (r[a].parameters = {
              ...e.visualization.parameters.instances[a].parameters,
              [s.split("-")[1]]: t,
            }),
            ...
            children: [
              ...
              (0, r.jsx)(i.Z, {
                ...
                onClick: () => {
                  let e = y
                    .map((e, s) => {
                      if (0 != s) return S(e.config, e.checkeds);
                    })
                    .slice(1);
                  e &&
                    e.map((e, s) => {
