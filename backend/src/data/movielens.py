...
class MovieLens(AbstractDataSet):
    def __init__(self, parameters: dict) -> None:
        ...
        """
        super().__init__()
        print("Aqui instancia a classe do MovieLens")
        default_keys = {"proportion"}
        parameters = process_parameters(parameters, default_keys)
        proportion = parameters.get("proportion", "ml-latest")
    ...
    def transform_columns_to_lenskit_pattern(
    ...
    def _load_ml_latest(self):
        ...
        is_ml_latest_empty = check_if_directory_is_empty(
            hrf_data_storage_path(), "ml-latest"
        )
    ...
    def _load_ml_latest_small(self) -> str:
        ...
        is_ml_latest_small_empty = check_if_directory_is_empty(
            hrf_data_storage_path(), "ml-latest-small"
        )
